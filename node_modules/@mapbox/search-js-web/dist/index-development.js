...
var MapboxGeocoder = class extends HTMLScopedElement {
  constructor() {
    ...
    __privateAdd(this, _search2, new import_search_js_core9.GeocodingCore({}));
    __privateAdd(this, _session3, new import_search_js_core9.SearchSession(__privateGet(this, _search2)));
...
var MapboxAddressMinimap = class extends HTMLScopedElement {
  constructor() {
    ...
    __privateAdd(this, _getImageUrl, (lngLatLike) => {
      ...
      let imgUrl = baseUrl + import_search_js_core10.LngLat.convert(lngLatLike).toArray().join(",") + "," + ZOOM + ",0/" + Math.min(__privateGet(this, _width) * 2, MAX_IMAGE_DIM) + "x" + Math.min(__privateGet(this, _height) * 2, MAX_IMAGE_DIM) + "?access_token=" + this.accessToken + "&attribution=false&logo=false";
...
var AddressAutofillInstance = class {
  constructor(collection, input, autofillRef) {
    ...
    __privateSet(this, _session4, new import_search_js_core11.SearchSession(autofillRef));
...
var AddressAutofillCollection = class extends import_search_js_core11.Evented {
  constructor({
    accessToken,
    options,
    theme,
    ...
    __privateAdd(this, _autofill2, new import_search_js_core11.AddressAutofillCore());
